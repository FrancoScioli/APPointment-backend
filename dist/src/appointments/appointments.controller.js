...
const require_tenant_guard_1 = require("../tenancy/require-tenant.guard");
...
let AppointmentsController = class AppointmentsController {
    ...
    slots(q) {
        if (!q?.date || !q?.serviceId || !q?.locationId) {
            throw new common_1.BadRequestException('Parámetros requeridos: date, serviceId, locationId');
        }
...
exports.AppointmentsController = AppointmentsController = __decorate([
    ...
    (0, common_1.UseGuards)(require_tenant_guard_1.RequireTenantGuard),
